...
<body class="text-center">
    ...
    <form id="form2" runat="server" class="form-signin" style="margin-top: 10%;">
            ...
            <input type="text" id="inputNombre" class="form-control" placeholder="Ingrese Nombre de Usuario" required="" autofocus=""/>
            ...
            <input type="password" id="inputContraseña" class="form-control" placeholder="Ingrese Contraseña" required=""/>
            <label for="inputPassword" class="sr-only">Repita Contraseña</label>
            <input type="password" id="inputContraseña2" class="form-control" placeholder="Repita Contraseña" required=""/>
