<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Sopa_de_Recetas_CREAR_RECETAS_INGREDIENTE.aspx.cs" Inherits="SDR.Apariencia.Sopa_de_Recetas_CREAR_RECETAS_INGREDIENTE" %>
        ...
        <form id="form1" runat="server">
            ...
            <div class="form-row" style="margin-top: 2%">
                ...
                <div class="form-group col-sm-3">
                    ...
                    <asp:DropDownList ID="DropDownList1" runat="server">
                        <asp:ListItem Value="0">Elegir Elementos...</asp:ListItem>
                        <asp:ListItem>Miligramos</asp:ListItem>
                        <asp:ListItem>Gramos</asp:ListItem>
                        <asp:ListItem>Kilogramos</asp:ListItem>
                        <asp:ListItem>Milimilistros</asp:ListItem>
                        <asp:ListItem>Litros</asp:ListItem>
                        <asp:ListItem>Cm3</asp:ListItem>
                        <asp:ListItem>Cucharada</asp:ListItem>
                        <asp:ListItem>Cucharadita</asp:ListItem>
                        <asp:ListItem>Taza</asp:ListItem>
                    </asp:DropDownList>
            ...
            <div class="form-row" style="margin-top: 2%">
                ...
                <div class="form-group col-sm-3">
                    ...
                    <br />
                    <asp:ListBox ID="LB_Ingredientes" runat="server"></asp:ListBox>
                    <br />
                    <asp:Button ID="Btn_El_Sel" runat="server" Text="Eliminar Ingrediente Seleccionado"  class="btn btn-primary" OnClick="Btn_El_Sel_Click"/>
                    <br />
