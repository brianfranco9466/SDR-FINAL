...
{
    public partial class Sopa_de_Recetas_CREAR_RECETAS_INSTRUCCIONES : System.Web.UI.Page
    {
        ...
        protected void btnAgregarInstruccion_Click(object sender, EventArgs e)
        {
            if (TxtDescripcion.Text != "" && TxtNroOrden.Text != "")
            {
                ...
                gestorInsXRec.AgregarInstruccion(TxtDescripcion.Text, TxtNroOrden.Text);
